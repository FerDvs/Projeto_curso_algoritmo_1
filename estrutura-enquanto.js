...
enquanto contador < limite faca
    ...
    leia(nome)
    escreva("Digite a idada do ", nome ,": ")
    leia(idade)
    se idade > 18 entao
 ...
 */
 ...
 function acaoBotao(){
    var Name, idade, limite, contador 
    ...
    while (contador < limite){
       ...
       if ( idade > 18 ) 
           document.getElementById ("paragrafo").innerText =  nome + " é : " + " você é maior de idade!"
       else
           document.getElementById ("paragrafo").innerText = nome + " é : " + " você é menor de idade!"
       contador ++
